...
const LAYERS = [
  {
    ...
    metric: "판독 가능 비율로 잰다. 임계 미만은 「미확인」",
  },
  {
    layer: "ai" as const,
    title: "판단층 (AI)",
    ...
    metric: "감리원 2인의 일치도(κ)가 상한 기준선이다",
  },
  {
    layer: "det" as const,
    title: "결정층 (규칙)",
  ...
  },
  {
    ...
    metric: "최종 확정과 서명은 책임건설사업관리기술인이 한다",
  },
];
...
export default function Home() {
  return (
    <Page
      ...
      lead={
        <>
          준공 2주 전, 최종보고서의 마지막 한 칸 「우수시공 및 실패시공 사례」 앞에서 담당자가
          멈춘다. 지난 2년간 무엇이 왜 불합격이었는지는 캐비닛의 스캔 수천 장 안에 있고, 결국
          기억나는 두세 건이 적힌다. <b>이 목업은 원본을 해시로 봉인한 채, 그 옆에 판정의 이유만
          다섯 칸으로 옮겨 적는 대장</b>을 보여 준다. 산출물은 대장이고 별지 제50호는 그 부산물이다.
        </>
      }
    >
        ...
        <div className="space-y-5">
          ...
          <Card title="세 칸을 더할 뿐이다">
            <p className="text-[12.5px] leading-relaxed text-[var(--ink)]">
              상시 비치 서식에 이미 들어 있는 <b>검측대장</b>에 세 칸을 더한다 —
    ...
    <div className="overflow-x-auto">
      ...
      >
        ...
        <text x={8} y={18} fontSize="10.5" fill="#6e7178">
          작성 시점 : 준공 직전 → <tspan fontWeight="700" fill="#b3261e">검측 종료 직후</tspan>
        </text>
      </svg>
    </div>
  );
